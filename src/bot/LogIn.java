...
public class LogIn {
	...
	public void prepareLogInPage(Map<String, String> inputParams) {
		...
		try {
			String response = client.httpGetUrl(Url.US_WATCH_IR + "?"
	...
	public void logInToSms(Map<String, String> inputParams) {
		...
		client.httpGetUrl(Url.US_E1S1 + inputParams.get("p_left"));

		System.out.println("Check: "+client.httpGetBody(Url.US_E1S2));

		URL test = null;
		try {
			test = new URL(Url.US_E1S2);
